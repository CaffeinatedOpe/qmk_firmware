...
[2] = LAYOUT_split_3x6_3(
	//,-----------------------------------------------------.                                 ,-----------------------------------------------------.
	TO(3),    KC_NO,    KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_VOLU,                                      KC_PGUP,    KC_NO,    KC_UP,    KC_NO,   KC_NO,  TD(RESET),
	//|--------+--------+--------+--------+--------+--------|                                 |--------+--------+--------+--------+--------+--------|
	KC_TAB,    KC_NO,   KC_LALT,    KC_LGUI,    KC_LCTL,    KC_MUTE,                                      KC_DEL,    KC_LEFT,    KC_DOWN,    KC_RIGHT, KC_NO, QK_MAKE,
	//|--------+--------+--------+--------+--------+--------|                                 |--------+--------+--------+--------+--------+--------|
